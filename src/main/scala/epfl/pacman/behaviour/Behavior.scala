...
import maze.Positions._
import maze.Directions._
...
abstract class Behavior {
  ...
  abstract class NextMethod(model: Model, c: Figure) extends Function0[Option[Direction]] {
    ...
    def siChassE = si(!model.pacman.hunter) _
    def siChasse = siChassE

    def siMonstrePrEs = si(model.minDistBetween(model.pacman.pos, model.pacman.pos, positions(model.monsters), Set[Position]()) < Settings.farDistance) _
    def siMonstresPrEs = siMonstrePrEs
    def siMonstrePres = siMonstrePrEs
    def siMonstresPres = siMonstrePrEs
    ...
    def enSEcuritEPendant(n: Int)(ds: Directions): Directions = {
    ...
    def enSecuritePendant(n: Int)(ds: Directions) = enSEcuritEPendant(n)(ds)
...
//          ifHunter {
//            move suchThat toAMonster
//          } otherwise {
//            ifMonsterClose {
//              move suchThat toAPoint
//            } otherwise {
//              move suchThat farFromMonsters
//            }
//          }
...
} // abstract class DefaultPacManBehavior
...
} // abstract class DefaultMonsterBehavior